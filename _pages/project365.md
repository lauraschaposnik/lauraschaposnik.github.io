...
The project started in 2013, and I have now entered the 10th year collecting moments in <b>300+ trips</b>. 
  ...
  <div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include  figure.liquid path="https://lauraschaposnik.com/assets/img/map.jpg" title="Krakow" class="img-fluid rounded z-depth-0" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include  figure.liquid path="https://lauraschaposnik.com/assets/img/January2022.jpeg" title="Project 365 2022" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
